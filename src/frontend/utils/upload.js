...
//   baseURL: "http://localhost:5555/drive/file",
// })


const api = axios.create({
  baseURL: 'http://localhost:5555/workspace/drive',
  headers: {
    Authorization:
      'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJlYTJiMGY3ZS1mNmM4LTQyNWMtYTdhZC1jMzNlMmQ2M2E4NmMiLCJyb2xlIjoiTEFOQ0VSIiwiaWF0IjoxNjgyNjYxMzM1LCJleHAiOjE2ODMyNjYxMzV9.AgES_HAUgCxfzXAnMZU5kJ_LW0l2NOHH2KnuDTvnWis',
    'Access-Control-Allow-Origin': '*',
    WorkspaceId: '44c0471b-f109-446b-8436-83fe2dd60610'
  },
})
  ...
  async initialize() {
    try {
      ...
      const videoInitializationUploadInput = {
        fileName: fileName,
        mimeType: 'video/mp4',
        parentId: '44c0471b-f109-446b-8436-83fe2dd60610',
